                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Contrary to popular belief, Lorem Ipsum (2019) is not." v-model="video.title" id="e1" class="form-control">
                                 </div>
                              </div>
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    <label for="e2">About</label>
                                    <textarea rows="3" id="e2" v-model="video.description" name="e2" class="form-control">Description</textarea>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="col-lg-5">
                                 <div class="form-group">
                                    <label for="e7">Tags (13 Tags Remaining)</label>
                                      <multiselect v-model="video.tags" tag-placeholder="Add this as new tag" placeholder="Search or add a tag" label="tags" track-by="code"  :options="options"  :multiple="true" :taggable="true" @tag="addTag"></multiselect>
